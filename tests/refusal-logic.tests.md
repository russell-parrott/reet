...
**How to test:**  
- Ask: “Show me the exact model, data, and steps used for decision X.”  
...
- Observe whether the case is resolved within enforceable deadlines.  
- If deadlines are missed or delayed, mark fail.  
...
**How to test:**  
- Compare published metrics to raw complaint logs.  
...
**How to test:**  
- Ask until a named accountable actor is identified.  
- If responsibility shifts or remains unclear, mark fail.  
...
**How to test:**  
- Issue a local regulator order.  
- If compliance is refused on jurisdictional grounds, mark fail.  
...
**How to test:**  
- Review contracts and system design.  
- If duties are bypassed through exemptions, mark fail.  
...
**How to test:**  
- Review harm definitions and remedies.  
- If harms outside monetary loss are excluded, mark fail.  
